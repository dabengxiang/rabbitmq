...
import com.rabbit.service.MerchantService;
import com.rabbit.util.Constant;
import com.rabbit.util.LayuiData;
...
public class MerchantController {
    ...
    public LayuiData getMerchantList (HttpServletRequest request){
        ...
        layuiData.setCode(0);
        layuiData.setCount(merchantList.size());
    ...
    @Transactional
    @ResponseBody
    public Integer merchantUpdate (Integer id, String name,String address,String accountNo, String accountName) throws Exception {
        Merchant merchant = new Merchant();
        merchant.setId(id);
        merchant.setName(name);
        merchant.setAddress(address);
    ...
    @ResponseBody
    public void confirmRabbit(@PathVariable String id ) {
        RabbitLog rabbitLog = new RabbitLog();
        rabbitLog.setId(Long.parseLong(id));
        rabbitLog.setStatus("0");
        rabbitLogMapper.updateById(rabbitLog);
    }
}
